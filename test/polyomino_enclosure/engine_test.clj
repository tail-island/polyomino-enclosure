...
(deftest test-area
  (is (= 3 (#'polyomino-enclosure.engine/area (#'polyomino-enclosure.engine/board [[0 0] [1 0] [2 0]]))))
  (is (= 2 (#'polyomino-enclosure.engine/area (#'polyomino-enclosure.engine/board [[0 0] [1 0] [2 1]]))))
  (is (= 3 (#'polyomino-enclosure.engine/area (#'polyomino-enclosure.engine/board [[0 0] [1 0] [2 1]])
                                              :search-8-way? true)))
  (is (thrown? ExceptionInfo
        (#'polyomino-enclosure.engine/area (#'polyomino-enclosure.engine/board (-> [[0 0] [1 0] [2 0]]
                                                                                   (#'polyomino-enclosure.engine/operate-polyomino #'polyomino-enclosure.engine/translate 1 1)))))))

(deftest test-validate-polyominos
  (is (= nil
         (validate-polyominos [[[0 0] [0 1] [0 2] [1 2]]
                               [[0 0] [0 1] [0 2] [0 3]]])))
  (is (= "不正なポリオミノがあります。"
         (validate-polyominos [[[0 0] [0 1] [0 2] [1 2]]
                               [[0 0] [0 1] [0 2]]])))
...
(deftest test-create-programs
  (is (= [[[:rotate-counter-clockwise] [:translate 0 1]]
          [[:flip-vertical] [:translate -4 3]]
          []
          [[:flip-vertical] [:translate -5 -1]]
          [[:flip-horizontal] [:translate -1 1]]
          [[:translate 1 -3] [:rotate-clockwise] [:rotate-clockwise] [:rotate-clockwise] [:rotate-clockwise]]
          [[:translate -3 -4]]]
